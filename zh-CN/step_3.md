...
<iframe src="https://editor.raspberrypi.org/zh-CN/embed/viewer/pick-your-favourite-dinosaur" width="100%" height="600" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>
...
**提示：** 你将要在这个步骤中添加大量代码，因此请确保使用复制 (<kbd>Ctrl</kbd>+<kbd>C</kbd> or <kbd>Cmd</kbd>+<kbd>C</kbd>) 和粘贴 (<kbd>Ctrl</kbd>+<kbd>V</kbd> or <kbd>Cmd</kbd>+<kbd>V</kbd>) 来更快的完成这个过程。
...
<div id="dropdown-options">
  ...
  <button onclick="option3()">剑龙</button>
</div>
